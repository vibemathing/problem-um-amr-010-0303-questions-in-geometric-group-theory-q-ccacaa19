...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0303-questions-in-geometric-group-theory-q-ccacaa19",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0303-8ae468258ed4",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0303"
      }
    ],
    "statement": {
      "language": "en",
      "text": "(J. Cornick) If G is f.g. and the homological dimension hd G = 1, is G free?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 3.3",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "863f2f85efe75fa0f25197c6683d94ec76dc8657eaafa53d077d4b5cb7dcc95b"
}
```
